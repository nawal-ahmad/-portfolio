# Nawal Ahmad Abu alShaikh Portfolio

- Number and name of feature: links, cards, icons, navbar, footer, buttons, labels, modal .. etc
- Estimate of time needed to complete: 3 hours

- Actual time needed to complete: About Seven non-consecutive hours <br/>

- [My Portfolio](https://laughing-kilby-1beb5e.netlify.app/) <br/>
